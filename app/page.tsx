  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_500px]">
              <div className="flex flex-col justify-center items-center text-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    GaanTaan lets you and your friends build collaborative playlists for parties, road trips,
              ...
              <div className="flex items-center justify-center">
                <div className="relative h-[350px] w-[300px] sm:h-[400px] sm:w-[350px] lg:h-[500px] lg:w-[400px] rounded-2xl overflow-hidden shadow-2xl">
                  <Image
                    src="/landing.png"
                    alt="GaanTaan app interface showing a collaborative playlist"
                    fill
        ...
        <section id="features" className="w-full py-12 md:py-24 lg:py-32 bg-purple-50">
          <div className="container px-4 md:px-6">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Creating the perfect group playlist is simple with GaanTaan.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
          ...
          <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6">
            <div className="space-y-3">
              ...
              <p className="mx-auto max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join GaanTaan today and start creating collaborative playlists with your friends, family, and
                colleagues.
              </p>
            </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          <div className="flex items-center gap-2">
            ...
            <p className="text-sm font-medium">© {new Date().getFullYear()} GaanTaan. All rights reserved.</p>
          </div>
